                ...
                <div class="container clearfix">
                    ...
                    <div class="main-menu hidden-md-down">
                        ...
                        <ul class="menu-list">
                            ...
                            <li><a class="nav-link" href="javascript:void(0)" data-target="#Services">Candidate</a></li>
                            <li><a class="nav-link" href="http://localhost:8080/IELTS/Admin.jsp">IELTS Admin</a></li>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row align-items-center">
                ...
                <form action="candilogin" method="post" "login100-form validate-form">
				...
				<div class="text-center">
					<a href="http://localhost:8080/IELTS/candireg.jsp" class="txt2 hov1">
						Sign Up
					</a>
				</div>
			</form>
        ...
        <section id="About">
            <div class="container">
                <div class="about-wrapper">
                    <h2>About Us</h2>
                    <p>The International English Language Testing System, or IELTS, is an international standardised test of English language proficiency for non-native English language speakers. It is jointly managed by the British Council, IDP: IELTS Australia and Cambridge Assessment English, and was established in 1989.
