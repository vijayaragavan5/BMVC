...
<tr><td class = "geeks"><span style="color:black;margin-right: 20px;"><b>Catagery: </b></span></td><td><select class="input100" multiple name="catagery">
  <option>Listening</option>
  <option>Speaking</option>
  <option>Reading</option> 
  <option>Writing</option>
</select></td></tr>
<tr><td class ="geeks"><span style="color:black;margin-right: 20px;"><b>BandwidthScore: </b></span></td><td><input class="input100" type="text" name="score"/></td></tr>  
...
<button type="submit" class="btn btn-primary btn-lg " id="load1" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Order">Submit Order</button>
